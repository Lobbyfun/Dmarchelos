            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                      ...
                      <?php else: ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="javascript:void(0)" id="login_now">Iniciar Sesión</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./admin">Administrador</a></li>
                      <?php endif; ?>
                    </ul>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2025 - Pizzeria D'marchelos </div></div>
        </footer>
